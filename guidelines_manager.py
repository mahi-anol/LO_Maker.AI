...
def _get_builtin_guidelines() -> dict:
    ...
    # ── Variety in Teacher Speech ─────────────────────────────────────────
    _add("mp_variety_rule", "বাক্যে বৈচিত্র্য (Anti-Repetition Rule)",
         "Master Prompt", "General Pedagogy",
         "পরপর দুটি বাক্য একই শব্দ বা বাক্যাংশ দিয়ে শুরু করা সম্পূর্ণ নিষিদ্ধ।\n"
         "\"শিক্ষক বলেন\" পরপর দুবার ব্যবহার করা যাবে না।\n"
         "এর পরিবর্তে পালা করে ব্যবহার করো:\n"
         "  শিক্ষক বলেন → এরপর জিজ্ঞেস করেন → ব্যাখ্যা করতে গিয়ে বলেন → নির্দেশ দেন → উৎসাহ দিয়ে বলেন → এবার জানতে চান\n"
         "\"শিক্ষক বোর্ডে লেখেন\" এর পরিবর্তে:\n"
         "  বোর্ডে ধাপগুলো লেখা হয় → বোর্ডে উদাহরণ দেখান → সমাধান করে দেখান\n"
